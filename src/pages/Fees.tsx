...
export default function Fees() {
  ...
  const generateInvoice = (invoiceNum: string, isReceipt = false) => {
    ...
    doc.text(
      isReceipt
        ? 'Receipt generated by the website.'
        : 'Please email proof of payment to info@poweroflove.edu.za',
      105,
      280,
      { align: 'center' }
    );
    ...
    return (
      <div className="max-w-2xl mx-auto py-24 px-4 text-center">
        ...
        <h1 className="text-4xl font-bold text-navy-900 mb-4">
          {lastMethod === 'PayFast' ? 'Payment Completed (Demo)' : 'Payment Initiated!'}
        </h1>
        ...
        {lastMethod === 'EFT' ? (
          ...
          <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-100 mb-8 text-left">
            ...
            <p className="text-sm text-yellow-800">
              This PayFast button is running in demo mode and does not process a real transaction.
            </p>
          </div>
        )}
            ...
            >
              <div className="bg-navy-900 p-6 text-white text-center">
                ...
                <p className="text-navy-300 text-sm">
                  {PAYFAST_DEMO_MODE ? 'Demo only. No real transaction will be processed.' : 'Redirecting to PayFast'}
                </p>
              </div>
              ...
              <div className="p-8 space-y-6">
                ...
                >
                  {isProcessing ? (
                    ...
                    'Confirm (Demo) and Generate Receipt'
                  )}
                </button>
